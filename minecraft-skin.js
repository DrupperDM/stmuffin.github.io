...
const MINECRAFT_CONFIG = {
  ...
  recentSkins: [
    ...
    // { label: 'Skin de verano', date: '2026-06', skin: 'images/skin-verano.png' },
     { label: 'Skin clasica', date: '2026-08', skin: 'images/skin1.png' },
     { label: 'Skin medieval', date: '2026-07', skin: 'images/skin2.png' },
     { label: 'Skin del Create Mod', date: '2026-06', skin: 'images/skin3.png' },
  ]
};
